                ...
                <div className="card-body">
                  <div className="d-flex flex-column align-items-center text-center">
                    ...
                    <div className="mt-3">
                      ...
                      <button
                        onClick={() =>
                          alert("This function is still not available.")
                        }
              ...
              <div className="card mt-3">
                <ul className="list-group list-group-flush">
                  ...
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span className="text-secondary">
                      {user.twitter ? user.twitter : "Unknown"}
                    </span>
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    <h6 className="mb-0">
                    ...
                    <span className="text-secondary">
                      {user.instagram ? user.instagram : "Unknown"}
                    </span>
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    <h6 className="mb-0">
                    ...
                    <span className="text-secondary">
                      {user.facebook ? user.facebook : "Unknown"}
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="card-body">
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-9 text-secondary">
                      {user.jobTitle ? user.jobTitle : "Unknown"}
                    </div>
                  </div>
                  <hr />
                  <div className="row">
                    ...
                    <div className="col-sm-9 text-secondary">
                      {user.mobile ? user.mobile : "Unknown"}
                    </div>
                  </div>
                  <hr />
                  <div className="row">
                  ...
                  <div className="row">
                    <div className="col-sm-3">
                      <h6 className="mb-0">Unknownress</h6>
                    </div>
                    <div className="col-sm-9 text-secondary">
